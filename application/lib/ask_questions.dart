...
// Function to send the user's prompt to the backend
  Future<Map<String, dynamic>> _sendToApi(
    ...
    final url = 'http://172.20.10.2:8080/ask_question';
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Image.asset('assets/vectors/warn.png', height: 60),
              SizedBox(height: 16),
              Text(
                'Please upload a PDF file or an Image',
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                if (image != null) {
                  ...
                  setState(() {
                    firstMessageText = 'Image Selected';
                    _selectedFile =
                        selectedImage; // Assign to a variable to display
                  ...
                  try {
                    ...
                    String url =
                        'http://172.20.10.2:8080/ask_question_document'; // Your API endpoint for image upload
                    var request = http.MultipartRequest('POST', Uri.parse(url));

                    // Add the image file to the request
                    request.files.add(await http.MultipartFile.fromPath(
                      'img', // The field name expected by the server
                      selectedImage.path,
                    ));
                    ...
                    if (response.statusCode == 200) {
                      setState(() {
                        ...
                        firstMessageText = 'Image uploaded successfully';
                      });
                    } else {
                      setState(() {
                        _isLoading = false;
                        firstMessageText = 'Image upload failed';
                      });
                      print(
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                if (image != null) {
                  ...
                  setState(() {
                    firstMessageText = 'Image Captured';
                    _selectedFile =
                        capturedImage; // Assign to a variable to display
                    _isLoading = true; // Set loading state to true
                  });
  ...
  void _pickPdf() async {
    ...
    if (result != null && result.files.isNotEmpty) {
      ...
      try {
        // Change localhost to the appropriate address
        String url =
            'http://172.20.10.2:8080/ask_question_document'; // For Android Emulator
              ...
              if (!_hasText)
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: _takePicture, // Call the takePicture function
                    child: Image.asset(
                      'assets/Icons/camera.png', // Replace with your camera icon asset
                      width: 30,
                      height: 30,
                    ),
                  ),
